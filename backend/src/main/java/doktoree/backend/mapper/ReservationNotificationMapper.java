...
public class ReservationNotificationMapper {
	...
	public static ReservationNotification mapToReservationNotification(
	...
	public static ReservationNotificationDto mapToReservationNotificationDto(
			ReservationNotification rn
	) {
